...
class ITK_EXPORT SpecialSkeletonPointsImageFilter : public itk::ImageToImageFilter<TInputImage,TOutputImage>
{
public:
...
#include "itkSpecialSkeletonPointsImageFilter.cxx"
#endif
