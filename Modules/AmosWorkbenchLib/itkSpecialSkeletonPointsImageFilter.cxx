#ifndef _itkSpecialSkeletonPointsImageFilter_cxx
#define _itkSpecialSkeletonPointsImageFilter_cxx
...
namespace itk
{
    ...
    SpecialSkeletonPointsImageFilter<TInputImage,TOutputImage>::SpecialSkeletonPointsImageFilter()
    {
    ...
    template <class TInputImage,class TOutputImage>
    void SpecialSkeletonPointsImageFilter<TInputImage,TOutputImage>::GenerateInputRequestedRegion() /*throw(InvalidRequestedRegionError)*/
    {
    ...
    template <class TInputImage,class TOutputImage>
    void SpecialSkeletonPointsImageFilter<TInputImage,TOutputImage>::EnlargeOutputRequestedRegion(DataObject *)
    {
	this->GetOutput()
    ...
    template <class TInputImage,class TOutputImage>
    void SpecialSkeletonPointsImageFilter<TInputImage,TOutputImage>::GenerateData()
    {
...
// 	cout << "AllIndexes " << AllIndexes.size() << endl;
	if (m_EndPoints) {
    ...
    template <class TInputImage,class TOutputImage>
    void SpecialSkeletonPointsImageFilter<TInputImage,TOutputImage>::PrintSelf(std::ostream& os, Indent indent) const
    {
