...
//         char X[] = "RegionList";
//         char Y[] = "Maximum number of regions is zero or negative.";
//         ErrorHandler(X, Y, FATAL);
...
void RegionList::ErrorHandler(std::string functName, std::string errmsg, ErrorType status)
{
