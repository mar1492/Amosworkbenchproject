...
void bgZoomIn(unsigned char** dest, unsigned char* src, int w, int h, int zconst, bool);
void bgZoomOut(unsigned char** dest, unsigned char* src, int w, int h, int zconst, bool);
