...
#ifndef MyQmitkToolSelectionBox_h_Included
#define MyQmitkToolSelectionBox_h_Included

#include <QmitkToolGUIArea.h>
#include "amosworkbenchproject_plugin_Export.h"
...
/**
  ...
  could be cases where two MyQmitkToolSelectionBox widgets are associated to the same ToolManager,
  but if this happens, please look deeply into the code.

  Last contributor: $Author: maleike $
*/
class AMOSWORKBENCH_EXPORTS MyQmitkToolSelectionBox : public QWidget
// class MyQmitkToolSelectionBox : public QWidget
//!
{
  Q_OBJECT
  ...
  public:
    ...
    MyQmitkToolSelectionBox(QWidget* parent = 0/*, mitk::DataStorage* storage = 0*/);
    virtual ~MyQmitkToolSelectionBox();
  ...
  signals:
    ...
    /// This signal is also emitted, when the whole MyQmitkToolSelectionBox get disabled. Then it will claim ToolSelected(-1)
