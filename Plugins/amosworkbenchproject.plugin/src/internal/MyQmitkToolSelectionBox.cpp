...
MyQmitkToolSelectionBox::MyQmitkToolSelectionBox(QWidget* parent/*, mitk::DataStorage* storage*/)
:QWidget(parent),
 m_SelfCall(false),
 ...
 m_EnabledMode(EnabledWithReferenceAndWorkingDataVisible)
{
  ...
  m_ToolManager->ActiveToolChanged += mitk::MessageDelegate<MyQmitkToolSelectionBox>( this, &MyQmitkToolSelectionBox::OnToolManagerToolModified );
  m_ToolManager->ReferenceDataChanged += mitk::MessageDelegate<MyQmitkToolSelectionBox>( this, &MyQmitkToolSelectionBox::OnToolManagerReferenceDataModified );
  m_ToolManager->WorkingDataChanged += mitk::MessageDelegate<MyQmitkToolSelectionBox>( this, &MyQmitkToolSelectionBox::OnToolManagerWorkingDataModified );
...
MyQmitkToolSelectionBox::~MyQmitkToolSelectionBox()
{
  m_ToolManager->ActiveToolChanged -= mitk::MessageDelegate<MyQmitkToolSelectionBox>( this, &MyQmitkToolSelectionBox::OnToolManagerToolModified );
  m_ToolManager->ReferenceDataChanged -= mitk::MessageDelegate<MyQmitkToolSelectionBox>( this, &MyQmitkToolSelectionBox::OnToolManagerReferenceDataModified );
  m_ToolManager->WorkingDataChanged -= mitk::MessageDelegate<MyQmitkToolSelectionBox>( this, &MyQmitkToolSelectionBox::OnToolManagerWorkingDataModified );
...
void MyQmitkToolSelectionBox::SetEnabledMode(EnabledMode mode)
{
  m_EnabledMode = mode;
  SetGUIEnabledAccordingToToolManagerState();
}

mitk::ToolManager* MyQmitkToolSelectionBox::GetToolManager()
{
  return m_ToolManager;
}

void MyQmitkToolSelectionBox::SetToolManager(mitk::ToolManager& newManager) // no NULL pointer allowed here, a manager is required
{
...
void MyQmitkToolSelectionBox::toolButtonClicked(int id)
{
...
void MyQmitkToolSelectionBox::OnToolManagerToolModified()
{
  SetOrUnsetButtonForActiveTool();
}

void MyQmitkToolSelectionBox::SetOrUnsetButtonForActiveTool()
{
...
void MyQmitkToolSelectionBox::OnToolManagerReferenceDataModified()
{
...
void MyQmitkToolSelectionBox::OnToolManagerWorkingDataModified()
{
  if (m_SelfCall) return;
...
///
  ...
  if(segType == Utils::Amos_BC) {      
    swapNode = workingNode;
    workingNode = workingBCNode;
    workingBCNode = swapNode;
  }
...
//                   && referenceNode->IsVisible(mitk::BaseRenderer::GetInstance( mitk::BaseRenderer::GetRenderWindowByName("AmosMultiWidgetAC")))
// 		  && referenceNode->IsVisible(mitk::BaseRenderer::GetInstance( mitk::BaseRenderer::GetRenderWindowByName("AmosMultiWidgetBC")))
...
//                   && isVisible();
    ...
    */
        ...
        enabled = enabled && referenceNode->IsVisible(mitk::BaseRenderer::GetInstance(      mitk::BaseRenderer::GetRenderWindowByName("stdmulti.widget0")));
        
		enabled = enabled && referenceNode->IsVisible(mitk::BaseRenderer::GetInstance( mitk::BaseRenderer::GetRenderWindowByName("stdmulti.widget3")));
        
        enabled = enabled && workingNode->IsVisible(mitk::BaseRenderer::GetInstance( mitk::BaseRenderer::GetRenderWindowByName("stdmulti.widget0")));
        
		enabled = enabled && workingBCNode->IsVisible(mitk::BaseRenderer::GetInstance( mitk::BaseRenderer::GetRenderWindowByName("stdmulti.widget3")));
...
*/
void MyQmitkToolSelectionBox::setEnabled( bool /*enable*/ )
{
  SetGUIEnabledAccordingToToolManagerState();
}


void MyQmitkToolSelectionBox::RecreateButtons()
{
...
//       button->setEnabled(false);
    ...
    tool->GUIProcessEventsMessage += mitk::MessageDelegate<MyQmitkToolSelectionBox>( this, &MyQmitkToolSelectionBox::OnToolGUIProcessEventsMessage ); // will never add a listener twice, so we don't have to check here
    tool->ErrorMessage += mitk::MessageDelegate1<MyQmitkToolSelectionBox, std::string>( this, &MyQmitkToolSelectionBox::OnToolErrorMessage ); // will never add a listener twice, so we don't have to check here
    tool->GeneralMessage += mitk::MessageDelegate1<MyQmitkToolSelectionBox, std::string>( this, &MyQmitkToolSelectionBox::OnGeneralToolMessage );
...
void MyQmitkToolSelectionBox::OnToolGUIProcessEventsMessage()
{
  qApp->processEvents();
}

void MyQmitkToolSelectionBox::OnToolErrorMessage(std::string s)
{
  QMessageBox::critical(this, "MITK", QString( s.c_str() ), QMessageBox::Ok, QMessageBox::NoButton, QMessageBox::NoButton);
}

void MyQmitkToolSelectionBox::OnGeneralToolMessage(std::string s)
{
  QMessageBox::information(this, "MITK", QString( s.c_str() ), QMessageBox::Ok, QMessageBox::NoButton, QMessageBox::NoButton);
}

void MyQmitkToolSelectionBox::SetDisplayedToolGroups(const std::string& toolGroups)
{
...
void MyQmitkToolSelectionBox::SetLayoutColumns(int columns)
{
...
void MyQmitkToolSelectionBox::SetShowNames(bool show)
{
  if (show != m_ShowNames)
  {
    m_ShowNames = show;
...
void MyQmitkToolSelectionBox::SetGenerateAccelerators(bool accel)
{
...
void MyQmitkToolSelectionBox::SetToolGUIArea( QWidget* parentWidget )
{
  m_ToolGUIWidget = parentWidget;
}

void MyQmitkToolSelectionBox::setTitle( const QString& /*title*/ )
{
}

void MyQmitkToolSelectionBox::showEvent( QShowEvent* e )
{
  QWidget::showEvent(e);
  SetGUIEnabledAccordingToToolManagerState();
}

void MyQmitkToolSelectionBox::hideEvent( QHideEvent* e )
{
  QWidget::hideEvent(e);
  SetGUIEnabledAccordingToToolManagerState();
}
