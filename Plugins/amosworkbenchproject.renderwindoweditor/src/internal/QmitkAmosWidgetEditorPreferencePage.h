...
#ifndef QmitkAmosWidgetEditorPreferencePage_h
#define QmitkAmosWidgetEditorPreferencePage_h
...
namespace Ui
{
class QmitkAmosWidgetEditorPreferencePage;
}

class QmitkAmosWidgetEditorPreferencePage : public QObject, public berry::IQtPreferencePage
{
  Q_OBJECT
  Q_INTERFACES(berry::IPreferencePage)

public:
  QmitkAmosWidgetEditorPreferencePage();
  ~QmitkAmosWidgetEditorPreferencePage();
...
private:
  QScopedPointer<Ui::QmitkAmosWidgetEditorPreferencePage> m_Ui;
  QWidget* m_Control;
};
#endif //QmitkAmosWidgetEditorPreferencePage_h
